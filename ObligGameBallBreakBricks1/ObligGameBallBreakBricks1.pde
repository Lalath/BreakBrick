...
1.Start implementing the ball only. It should bounce off three of the edges of the window, and vanish at the bottom of the screen. The game should just quit if this happens.

Test and make sure this works before continuing.

Save a backup of your file before you continue, you might need to go back to it if you mess things up.
